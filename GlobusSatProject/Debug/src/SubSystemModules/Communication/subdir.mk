...
src/SubSystemModules/Communication/%.o: ../src/SubSystemModules/Communication/%.c
	...
	arm-none-eabi-gcc -mcpu=arm926ej-s -std=c99 -O0 -fmessage-length=0 -ffunction-sections -Wall -Wextra  -g -std=c99 -Dsdram -Dat91sam9g20 -DTRACE_LEVEL=5 -DDEBUG=1 -D'BASE_REVISION_NUMBER=$(REV)' -D'BASE_REVISION_HASH_SHORT=$(REVHASH_SHORT)' -D'BASE_REVISION_HASH=$(REVHASH)' -I"C:/ISIS/workspace/SecretGlobusSatProject-Change-Eitan/GlobusSatProject/..//satellite-subsystems/satellite-subsystems/include" -I"C:\ISIS\workspace\SecretGlobusSatProject-Change-Eitan\GlobusSatProject\src" -I"C:/ISIS/workspace/SecretGlobusSatProject-Change-Eitan/GlobusSatProject/..//hal/hcc/include" -I"C:/ISIS/workspace/SecretGlobusSatProject-Change-Eitan/GlobusSatProject/..//hal/freertos/include" -I"C:/ISIS/workspace/SecretGlobusSatProject-Change-Eitan/GlobusSatProject/..//hal/hal/include" -I"C:/ISIS/workspace/SecretGlobusSatProject-Change-Eitan/GlobusSatProject/..//hal/at91/include" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -c -o "$@" "$<"
